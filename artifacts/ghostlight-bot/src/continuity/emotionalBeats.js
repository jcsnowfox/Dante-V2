...
function isUnsafeProviderText(text) { return /the request was rejected because it was considered high risk|rejected because it was considered|considered high risk|flagged (by the safety system|as high risk)|moderation rejected|provider rejected|raw stack|\{\s*"error"/i.test(textOf(text)); }
