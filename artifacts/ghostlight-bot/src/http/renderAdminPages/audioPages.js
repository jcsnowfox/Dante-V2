...
function renderAudioSettingsPage({ config, voiceOptions = [], theme = "light", helpers }) {
  ...
  return [
    ...
    "<input type=\"hidden\" name=\"audioTtsEnabled\" value=\"false\">",
    "<span class=\"switch-control\">",
    `<input type="checkbox" name="audioTtsEnabled" value="true"${state.audioTtsEnabled ? " checked" : ""}>`,
    "<span></span>",
    "</span>",
    "<span class=\"switch-label\">Enable ElevenLabs Voice Tool</span>",
    "</label>",
