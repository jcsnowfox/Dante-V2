...
function renderPeopleObjectsPanel({ relationships, objectRelationships, companionId, escapeHtml, withThemeField, theme, disabledAttr }) {
  ...
  const avatarForm = [
    ...
    `<div class="ghb-field" style="flex:1 1 140px"><label class="ghb-section-title" style="font-size:.9rem;display:block;margin-bottom:4px">Category</label><input name="category" type="text" placeholder="e.g. close_friend, family_member" style="${inputStyle}"${disabledAttr}></div>`,
    ...
    "</div>",
    "<div style=\"display:flex;gap:8px;flex-wrap:wrap;margin-bottom:6px\">",
    `<div class="ghb-field" style="flex:1 1 180px"><label class="ghb-section-title" style="font-size:.9rem;display:block;margin-bottom:4px">Preferred Display Name <span style="opacity:.6;font-weight:400">(override for alternate avatars)</span></label><input name="preferredDisplayName" type="text" placeholder="e.g. Alex (if SL name differs)" style="${inputStyle}"${disabledAttr}></div>`,
    `<div class="ghb-field" style="flex:1 1 260px"><label class="ghb-section-title" style="font-size:.9rem;display:block;margin-bottom:4px">Identity Note <span style="opacity:.6;font-weight:400">(shown to model when they speak)</span></label><input name="identityNote" type="text" placeholder="e.g. This is an alternate avatar for this person." style="${inputStyle}"${disabledAttr}></div>`,
    "</div>",
    "<div style=\"display:flex;gap:8px;flex-wrap:wrap;margin-bottom:6px\">",
    ...
    "</div>",
    "<div style=\"display:flex;gap:8px;flex-wrap:wrap;margin-bottom:6px\">",
    `<div class="ghb-field" style="flex:1 1 200px"><label class="ghb-section-title" style="font-size:.9rem;display:block;margin-bottom:4px">Relation to user</label><input name="relationshipToUser" type="text" placeholder="e.g. longtime friend" style="${inputStyle}"${disabledAttr}></div>`,
    `<div class="ghb-field" style="flex:1 1 200px"><label class="ghb-section-title" style="font-size:.9rem;display:block;margin-bottom:4px">Relation to companion</label><input name="relationshipToCompanion" type="text" placeholder="e.g. close friend, protective energy" style="${inputStyle}"${disabledAttr}></div>`,
    "</div>",
  ...
  const objectForm = [
    ...
    "</div>",
    "<div style=\"display:flex;gap:8px;flex-wrap:wrap;margin-bottom:6px\">",
    `<div class="ghb-field" style="flex:1 1 200px"><label class="ghb-section-title" style="font-size:.9rem;display:block;margin-bottom:4px">Relation to user</label><input name="relationshipToUser" type="text" placeholder="e.g. owner's child avatar" style="${inputStyle}"${disabledAttr}></div>`,
    `<div class="ghb-field" style="flex:1 1 200px"><label class="ghb-section-title" style="font-size:.9rem;display:block;margin-bottom:4px">Relation to companion</label><input name="relationshipToCompanion" type="text" placeholder="e.g. child avatar companion" style="${inputStyle}"${disabledAttr}></div>`,
    "</div>",
    "<div style=\"display:flex;gap:10px;flex-wrap:wrap;margin-bottom:8px\">",
    `<label class="ghb-copy" style="display:flex;gap:6px;align-items:center"><input type="checkbox" name="childSafeOnly" value="true"${disabledAttr}> Child-safe only</label>`,
    `<label class="ghb-copy" style="display:flex;gap:6px;align-items:center"><input type="checkbox" name="publicIdentityContextEnabled" value="true" checked${disabledAttr}> Public identity context</label>`,
