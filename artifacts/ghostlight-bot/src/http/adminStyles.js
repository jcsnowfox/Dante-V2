...
/* Nordic cinematic dashboard design system: inert until Phase 3 renderers opt in. */
:root{--gl-midnight:#03040a;--gl-deep-fjord:#07111f;--gl-fjord-teal:#0f766e;--gl-aurora-cyan:#39d7f0;--gl-aurora-violet:#a855f7;--gl-ice-silver:#d8e7ef;--gl-bronze-rune:#9a6a35;--gl-gold-rune:#d6b56d;--gl-glass-bg:rgba(8,17,31,.72);--gl-glass-border:rgba(216,231,239,.18);--gl-text-primary:#f8fbff;--gl-text-muted:#a9b7c7}
.nordic-dashboard{color:var(--gl-text-primary);isolation:isolate}.nordic-bg{position:relative;background:radial-gradient(circle at 12% 8%,rgba(57,215,240,.2),transparent 34%),radial-gradient(circle at 85% 0,rgba(168,85,247,.2),transparent 32%),linear-gradient(135deg,var(--gl-midnight),var(--gl-deep-fjord));overflow:hidden}.nordic-bg::before{content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(115deg,transparent 0 26%,rgba(57,215,240,.08) 36%,rgba(168,85,247,.08) 48%,transparent 62%),repeating-linear-gradient(90deg,rgba(214,181,109,.055) 0 1px,transparent 1px 42px);mix-blend-mode:screen;opacity:.8}.nordic-panel{position:relative;border:1px solid var(--gl-glass-border);border-radius:24px;background:linear-gradient(145deg,rgba(8,17,31,.86),rgba(3,4,10,.72));box-shadow:0 24px 80px rgba(0,0,0,.38),inset 0 1px 0 rgba(255,255,255,.08);backdrop-filter:blur(18px);padding:clamp(18px,2.2vw,30px);overflow:hidden}.nordic-panel::before{content:"";position:absolute;inset:0;border-radius:inherit;pointer-events:none;background:linear-gradient(135deg,rgba(214,181,109,.28),transparent 22%,transparent 78%,rgba(57,215,240,.2));mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude;padding:1px}.nordic-panel--hero{min-height:260px}.nordic-panel--wide{grid-column:1/-1}.nordic-panel--compact{padding:16px;border-radius:18px}.nordic-panel__header{position:relative;z-index:1;display:flex;align-items:flex-start;gap:14px;margin-bottom:16px}.nordic-panel__title-wrap{min-width:0;flex:1}.nordic-panel__title{margin:0;color:var(--gl-text-primary);font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(1.45rem,2vw,2rem);line-height:1}.nordic-panel__body{position:relative;z-index:1;color:var(--gl-text-muted);margin:.4rem 0 0;max-width:72ch}.nordic-panel__actions{display:flex;flex-wrap:wrap;gap:8px;justify-content:flex-end}.nordic-panel__icon,.nordic-stat-card__icon,.nordic-timeline__icon,.nordic-journal-card__icon{display:inline-grid;place-items:center;width:42px;height:42px;border-radius:14px;border:1px solid rgba(57,215,240,.22);background:rgba(57,215,240,.08);color:var(--gl-aurora-cyan);box-shadow:0 0 28px rgba(57,215,240,.16)}.nordic-stat-card{display:flex;align-items:center;gap:14px;min-height:112px;padding:18px;border:1px solid var(--gl-glass-border);border-radius:20px;text-decoration:none;color:var(--gl-text-primary);background:linear-gradient(145deg,rgba(216,231,239,.08),rgba(8,17,31,.68));box-shadow:inset 0 1px 0 rgba(255,255,255,.07);transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}.nordic-stat-card:hover{transform:translateY(-2px);border-color:rgba(57,215,240,.5);box-shadow:0 18px 44px rgba(57,215,240,.1)}.nordic-stat-card__copy{display:grid;gap:2px;min-width:0}.nordic-stat-card__label,.nordic-eyebrow{color:var(--gl-gold-rune);font-size:.76rem;letter-spacing:.12em;text-transform:uppercase;font-weight:800}.nordic-stat-card__value{font-size:clamp(1.45rem,2.2vw,2.2rem);line-height:1}.nordic-stat-card__detail{color:var(--gl-text-muted);font-size:.9rem}.nordic-hero{position:relative;z-index:1;display:grid;grid-template-columns:minmax(0,1fr) minmax(160px,280px);gap:24px;align-items:center}.nordic-hero__title{margin:0;color:var(--gl-text-primary);font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(3rem,6vw,5.8rem);line-height:.86;letter-spacing:-.04em}.nordic-hero__subtitle{color:var(--gl-text-muted);font-size:1.06rem;max-width:62ch}.nordic-hero__actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:18px}.nordic-hero__sigil{justify-self:end;display:grid;place-items:center;width:min(100%,240px);aspect-ratio:1;border-radius:50%;color:var(--gl-aurora-cyan);background:radial-gradient(circle,rgba(57,215,240,.18),rgba(168,85,247,.12) 46%,transparent 70%);filter:drop-shadow(0 0 40px rgba(57,215,240,.22))}.nordic-hero__sigil .nordic-icon{width:44%;height:44%}.nordic-icon{width:var(--nordic-icon-size,1.2em);height:var(--nordic-icon-size,1.2em);object-fit:contain;flex:none}.nordic-pill{display:inline-flex;align-items:center;justify-content:center;gap:7px;min-height:34px;padding:0 12px;border:1px solid rgba(216,181,109,.28);border-radius:999px;background:rgba(214,181,109,.08);color:var(--gl-ice-silver);font-weight:800;font-size:.82rem;text-decoration:none}.nordic-pill--cyan{border-color:rgba(57,215,240,.35);background:rgba(57,215,240,.1);color:var(--gl-aurora-cyan)}.nordic-pill--violet{border-color:rgba(168,85,247,.4);background:rgba(168,85,247,.12);color:#e9d5ff}.nordic-divider{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:14px;color:var(--gl-gold-rune);letter-spacing:.12em;text-transform:uppercase;font-weight:900;font-size:.78rem}.nordic-divider::before,.nordic-divider::after{content:"";height:1px;background:linear-gradient(90deg,transparent,rgba(214,181,109,.62),transparent)}.nordic-carousel{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(220px,28%);gap:14px;overflow-x:auto;scroll-snap-type:x proximity;padding:4px 2px 12px}.nordic-carousel>*{scroll-snap-align:start}.nordic-timeline{display:grid;gap:12px}.nordic-timeline__item{display:flex;gap:12px;padding:14px;border:1px solid rgba(216,231,239,.12);border-radius:18px;background:rgba(216,231,239,.055);color:var(--gl-text-primary);text-decoration:none}.nordic-timeline__copy{display:grid;gap:3px;color:var(--gl-text-muted)}.nordic-timeline__copy strong{color:var(--gl-text-primary)}.nordic-timeline__copy time{color:var(--gl-gold-rune);font-size:.8rem}.nordic-journal-card,.nordic-recipe-card,.battle-rhythm-card,.travel-saga-card,.concierge-card{display:grid;gap:10px;padding:18px;border:1px solid rgba(216,231,239,.14);border-radius:20px;background:linear-gradient(145deg,rgba(216,231,239,.08),rgba(8,17,31,.62));color:var(--gl-text-primary);text-decoration:none}.nordic-journal-card h3,.nordic-recipe-card h3,.battle-rhythm-card h3,.travel-saga-card h3,.concierge-card h3{margin:0;font-family:'Cormorant Garamond',Georgia,serif;font-size:1.45rem;line-height:1}.nordic-journal-card p,.nordic-recipe-card p,.travel-saga-card p,.concierge-card p{margin:0;color:var(--gl-text-muted)}.nordic-journal-card__date{color:var(--gl-gold-rune);font-size:.82rem;font-weight:800}.nordic-recipe-card__meta{display:flex;flex-wrap:wrap;gap:8px}.battle-rhythm-card ul{margin:.2rem 0 0;padding-left:1.1rem;color:var(--gl-text-muted)}.travel-checklist-item{display:flex;gap:10px;align-items:flex-start;padding:12px;border:1px solid rgba(216,231,239,.12);border-radius:16px;background:rgba(216,231,239,.055);color:var(--gl-text-primary)}.travel-checklist-item__mark{display:inline-grid;place-items:center;width:22px;height:22px;border:1px solid rgba(214,181,109,.4);border-radius:50%;color:var(--gl-aurora-cyan);font-weight:900}.travel-checklist-item small{display:block;color:var(--gl-text-muted);margin-top:2px}.travel-checklist-item.is-complete{border-color:rgba(57,215,240,.28)}.nordic-empty{color:var(--gl-text-muted);margin:0}.nordic-dashboard a:focus-visible,.nordic-panel a:focus-visible,.nordic-pill:focus-visible,.nordic-stat-card:focus-visible,.nordic-timeline__item:focus-visible,.nordic-journal-card:focus-visible,.nordic-recipe-card:focus-visible,.battle-rhythm-card:focus-visible,.travel-saga-card:focus-visible{outline:2px solid var(--gl-aurora-cyan);outline-offset:3px}
@media(max-width:900px){.nordic-hero{grid-template-columns:1fr}.nordic-hero__sigil{justify-self:start;width:150px}.nordic-carousel{grid-auto-columns:minmax(190px,80%)}}
@media(prefers-reduced-motion:reduce){.nordic-stat-card{transition:none}.nordic-stat-card:hover{transform:none}.nordic-bg::before{opacity:.45}}

/* Dante Nordic Home dashboard Phase 3: main content only; sidebar shell remains unchanged. */
.nordic-home-shell{position:relative;display:grid;gap:22px;min-height:100%;padding:clamp(16px,2vw,28px);border-radius:30px;background-image:linear-gradient(135deg,rgba(3,7,18,.88),rgba(8,17,31,.78)),var(--nordic-home-bg);background-size:cover;background-position:center;color:var(--gl-text-primary);overflow:hidden}.nordic-home-shell::after{content:"";position:absolute;inset:0;pointer-events:none;background:radial-gradient(circle at 24% 8%,rgba(57,215,240,.18),transparent 26%),radial-gradient(circle at 90% 12%,rgba(168,85,247,.2),transparent 24%),linear-gradient(115deg,transparent,rgba(214,181,109,.05),transparent);mix-blend-mode:screen}.nordic-home-shell>*{position:relative;z-index:1}.nordic-home-top{display:grid;grid-template-columns:minmax(0,1.25fr) minmax(340px,.75fr);gap:22px;align-items:stretch}.nordic-home-middle{display:grid;grid-template-columns:minmax(260px,.85fr) minmax(340px,1.1fr) minmax(280px,.9fr);gap:22px;align-items:stretch}.nordic-home-lower{display:grid;grid-template-columns:minmax(360px,1.2fr) repeat(3,minmax(220px,.8fr));gap:22px;align-items:stretch}.nordic-home-hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(180px,290px);gap:24px;align-items:center}.nordic-home-hero h1{margin:0;color:var(--gl-text-primary);font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(3.4rem,7vw,7rem);line-height:.82;letter-spacing:-.055em;text-shadow:0 0 44px rgba(57,215,240,.18)}.nordic-home-hero p{max-width:65ch;color:var(--gl-text-muted);line-height:1.55}.nordic-home-hero__actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:18px}.nordic-home-hero__portrait,.nordic-home-hero__empty{width:min(100%,280px);aspect-ratio:4/5;border-radius:28px;border:1px solid rgba(214,181,109,.34);box-shadow:0 30px 90px rgba(0,0,0,.45),0 0 60px rgba(57,215,240,.12);background:linear-gradient(145deg,rgba(57,215,240,.14),rgba(168,85,247,.12));object-fit:cover;justify-self:end}.nordic-home-hero__empty{display:grid;place-items:center;align-content:center;gap:12px;color:var(--gl-aurora-cyan);text-align:center}.nordic-home-setup-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.nordic-home-setup-card{display:flex;align-items:center;gap:10px;min-height:82px;padding:12px;border:1px solid rgba(216,231,239,.13);border-radius:18px;background:rgba(216,231,239,.06);color:var(--gl-text-primary);text-decoration:none}.nordic-home-setup-card .nordic-icon{--nordic-icon-size:1.75rem}.nordic-home-setup-card small{display:block;color:var(--gl-gold-rune);font-size:.7rem;text-transform:uppercase;letter-spacing:.09em}.nordic-home-setup-card strong{display:block;margin-top:3px}.nordic-home-feature-row{display:flex;flex-wrap:wrap;gap:8px;margin-top:14px}.nordic-home-feature-pill{display:inline-flex;align-items:center;gap:7px;min-height:32px;padding:0 10px;border:1px solid rgba(216,231,239,.14);border-radius:999px;color:var(--gl-text-muted);text-decoration:none;background:rgba(216,231,239,.045);font-size:.8rem;font-weight:800}.nordic-home-feature-pill.is-active{border-color:rgba(57,215,240,.42);color:var(--gl-aurora-cyan);background:rgba(57,215,240,.09)}.nordic-home-feature-pill .nordic-icon{--nordic-icon-size:1rem}.nordic-home-action-list,.nordic-home-recipe-list,.nordic-home-checklist,.nordic-home-travel-cards,.nordic-home-innerlife{display:grid;gap:12px}.nordic-home-action{display:flex;gap:12px;align-items:flex-start;padding:13px;border-radius:17px;border:1px solid rgba(216,231,239,.13);background:rgba(216,231,239,.055);color:var(--gl-text-primary);text-decoration:none}.nordic-home-action.is-muted{opacity:.72}.nordic-home-action small,.nordic-home-action time,.nordic-home-innerlife span{display:block;color:var(--gl-text-muted);margin-top:3px}.nordic-home-gallery-track,.nordic-home-journal-ribbon{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(210px,42%);gap:14px;overflow-x:auto;overscroll-behavior-inline:contain;scroll-snap-type:x proximity;padding:3px 2px 12px}.nordic-home-gallery-tile{position:relative;display:block;aspect-ratio:var(--home-image-aspect,4/5);min-height:260px;overflow:hidden;border-radius:22px;border:1px solid rgba(214,181,109,.26);background:rgba(216,231,239,.06);scroll-snap-align:start;color:#fff;text-decoration:none}.nordic-home-gallery-tile img{width:100%;height:100%;object-fit:cover;display:block}.nordic-home-empty-gallery{display:grid;place-items:center;gap:12px;min-height:260px;border:1px dashed rgba(214,181,109,.34);border-radius:22px;color:var(--gl-text-muted);background:rgba(0,0,0,.14)}.nordic-home-recipe-card{display:grid;grid-template-columns:96px 1fr;gap:12px;align-items:center;padding:12px;border-radius:18px;border:1px solid rgba(216,231,239,.13);background:rgba(216,231,239,.055)}.nordic-home-recipe-card img{width:96px;height:82px;object-fit:cover;border-radius:14px}.nordic-home-recipe-card h3{margin:0;color:var(--gl-text-primary);font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem}.nordic-home-recipe-card p,.nordic-home-rhythm-summary p,.nordic-home-concierge p{margin:.2rem 0;color:var(--gl-text-muted)}.nordic-home-battle-grid{display:grid;grid-template-columns:repeat(7,minmax(135px,1fr));gap:10px;overflow-x:auto;padding-bottom:6px}.nordic-home-battle-grid .battle-rhythm-card{min-width:135px;padding:14px}.nordic-home-travel-map{min-height:130px;border-radius:20px;overflow:hidden;border:1px solid rgba(57,215,240,.18);margin-bottom:12px}.nordic-home-travel-map img{width:100%;height:100%;object-fit:cover;display:block;opacity:.82}.nordic-home-alerts{display:grid;gap:10px}.nordic-home-alert,.nordic-home-update{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:14px 16px;border:1px solid rgba(248,113,113,.24);border-radius:18px;background:rgba(127,29,29,.2)}.nordic-home-alert span{color:var(--gl-text-muted)}.nordic-home-muted{color:var(--gl-text-muted)}.nordic-home-journals .nordic-journal-card{min-width:210px;scroll-snap-align:start}.nordic-home-concierge{display:grid;gap:12px}.nordic-home-innerlife{margin-top:14px}.nordic-home-innerlife article{padding:12px;border-radius:16px;border:1px solid rgba(168,85,247,.18);background:rgba(168,85,247,.06)}@media(max-width:1280px){.nordic-home-top,.nordic-home-middle,.nordic-home-lower{grid-template-columns:1fr 1fr}.nordic-home-gallery,.nordic-home-battle{grid-column:1/-1}.nordic-home-setup-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.nordic-home-shell{padding:14px;border-radius:20px}.nordic-home-top,.nordic-home-middle,.nordic-home-lower,.nordic-home-hero{grid-template-columns:1fr}.nordic-home-hero__portrait,.nordic-home-hero__empty{justify-self:start;width:min(100%,220px)}.nordic-home-setup-grid{grid-template-columns:1fr}.nordic-home-gallery-track,.nordic-home-journal-ribbon{grid-auto-columns:86%}.nordic-home-alert,.nordic-home-update{align-items:flex-start;flex-direction:column}.nordic-home-recipe-card{grid-template-columns:82px 1fr}.nordic-home-recipe-card img{width:82px;height:74px}}

/* Dante Nordic Home dashboard Phase 4.5 visual correction: wide cinematic desktop layout. */
main:has(.nordic-home-wide){max-width:none;width:100%;margin:0;box-sizing:border-box}.admin-main:has(.nordic-home-wide){width:100%;max-width:none;min-width:0}.nordic-home-wide{width:min(100%,1900px);max-width:none;margin:0 auto;box-sizing:border-box}.nordic-home-wide .nordic-home-top{grid-template-columns:minmax(0,1.65fr) minmax(360px,.95fr);gap:clamp(18px,1.6vw,30px)}.nordic-home-wide .nordic-home-middle{grid-template-columns:minmax(240px,.72fr) minmax(520px,1.56fr) minmax(270px,.72fr);gap:clamp(18px,1.6vw,30px)}.nordic-home-wide .nordic-home-lower{grid-template-columns:repeat(3,minmax(300px,1fr));gap:clamp(18px,1.6vw,30px)}.nordic-home-wide .nordic-home-battle{grid-column:1/-1}.nordic-home-wide .nordic-home-hero{grid-template-columns:minmax(0,1fr) minmax(280px,420px);min-height:clamp(430px,38vw,620px);align-items:end;background-image:linear-gradient(110deg,rgba(3,7,18,.1),rgba(3,7,18,.72)),url('/assets/nordic-dashboard/03-frames/violet-crystal-frame.png');background-size:cover;background-position:center;border-color:rgba(214,181,109,.28)}.nordic-home-wide .nordic-home-hero h1{font-size:clamp(4rem,6.8vw,8.5rem);max-width:9ch}.nordic-home-hero__status{display:flex;flex-wrap:wrap;gap:8px;margin:.8rem 0 0}.nordic-home-hero__status span{display:inline-flex;align-items:center;min-height:30px;padding:0 11px;border:1px solid rgba(57,215,240,.32);border-radius:999px;background:rgba(57,215,240,.09);color:var(--gl-aurora-cyan);font-size:.78rem;font-weight:900;text-transform:uppercase;letter-spacing:.08em}.nordic-home-hero__excerpt{font-size:1.05rem;max-width:54ch}.nordic-home-wide .nordic-home-hero__portrait,.nordic-home-wide .nordic-home-hero__empty{width:min(100%,420px);min-height:420px;border-radius:34px}.nordic-home-wide .nordic-home-setup-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.nordic-home-wide .nordic-home-setup-card{min-height:108px;padding:16px;align-items:flex-start;background:linear-gradient(145deg,rgba(216,231,239,.085),rgba(57,215,240,.045))}.nordic-home-wide .nordic-home-setup-card strong{font-size:1.03rem;line-height:1.18}.nordic-home-wide .nordic-home-gallery-track{grid-auto-columns:minmax(280px,43%);gap:18px;padding-bottom:10px;scrollbar-width:thin}.nordic-home-wide .nordic-home-gallery-tile{min-height:360px;aspect-ratio:16/10}.nordic-home-wide .nordic-home-recipe-list{gap:14px}.nordic-home-wide .nordic-home-recipe-card{grid-template-columns:128px 1fr;min-height:134px;padding:14px}.nordic-home-wide .nordic-home-recipe-card img{width:128px;height:108px}.nordic-home-wide .nordic-home-battle-grid{grid-template-columns:repeat(7,minmax(120px,1fr));overflow:visible;gap:12px}.nordic-home-wide .nordic-home-battle-grid .battle-rhythm-card{min-width:0;padding:14px 12px}.nordic-home-wide .battle-rhythm-card h3{font-size:1.18rem}.nordic-home-wide .battle-rhythm-card ul{padding-left:1rem;font-size:.88rem}.nordic-home-wide .nordic-home-travel-map{min-height:220px}.nordic-home-wide .nordic-home-travel-cards{grid-template-columns:repeat(3,minmax(0,1fr))}.nordic-home-wide .nordic-home-checklist{grid-template-columns:1fr;align-content:start}.nordic-home-wide .nordic-home-concierge{min-height:220px;align-content:center;background:linear-gradient(135deg,rgba(57,215,240,.08),rgba(168,85,247,.08));border-radius:22px;padding:18px}@media(max-width:1280px){.nordic-home-wide .nordic-home-top,.nordic-home-wide .nordic-home-middle,.nordic-home-wide .nordic-home-lower{grid-template-columns:1fr 1fr}.nordic-home-wide .nordic-home-gallery,.nordic-home-wide .nordic-home-battle{grid-column:1/-1}.nordic-home-wide .nordic-home-travel-cards{grid-template-columns:1fr}.nordic-home-wide .nordic-home-battle-grid{overflow-x:auto;grid-template-columns:repeat(7,minmax(145px,1fr))}}@media(max-width:760px){main:has(.nordic-home-wide){width:100%}.nordic-home-wide .nordic-home-top,.nordic-home-wide .nordic-home-middle,.nordic-home-wide .nordic-home-lower,.nordic-home-wide .nordic-home-hero{grid-template-columns:1fr}.nordic-home-wide .nordic-home-hero{min-height:auto}.nordic-home-wide .nordic-home-hero__portrait,.nordic-home-wide .nordic-home-hero__empty{justify-self:start;width:min(100%,260px);min-height:320px}.nordic-home-wide .nordic-home-gallery-track{grid-auto-columns:86%}.nordic-home-wide .nordic-home-recipe-card{grid-template-columns:96px 1fr}.nordic-home-wide .nordic-home-recipe-card img{width:96px;height:86px}}

/* Dante Nordic Home dashboard Phase 4.6: cinematic asset polish and live-only gallery fix. */
.nordic-home-wide.nordic-bg{background-image:radial-gradient(circle at 18% 12%,rgba(57,215,240,.24),transparent 26%),radial-gradient(circle at 82% 18%,rgba(168,85,247,.20),transparent 28%),linear-gradient(180deg,rgba(3,4,10,.30),rgba(3,4,10,.92)),var(--nordic-home-bg);background-size:cover;background-attachment:fixed}.nordic-home-shell::before{content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(90deg,rgba(0,0,0,.54),transparent 18%,transparent 78%,rgba(0,0,0,.58)),radial-gradient(ellipse at center,transparent 42%,rgba(0,0,0,.72) 100%),var(--nordic-home-fortress);background-size:cover;opacity:.34;mix-blend-mode:screen}.nordic-home-shell::after{background:radial-gradient(circle at 24% 8%,rgba(57,215,240,.24),transparent 24%),radial-gradient(circle at 72% 28%,rgba(214,181,109,.16),transparent 20%),linear-gradient(115deg,transparent,rgba(214,181,109,.08),transparent),repeating-linear-gradient(90deg,rgba(214,181,109,.045) 0 1px,transparent 1px 54px);opacity:.88}.nordic-home-wide .nordic-panel{border-color:rgba(214,181,109,.24);background-image:linear-gradient(145deg,rgba(3,7,18,.88),rgba(8,17,31,.74)),var(--nordic-home-frame);background-size:cover,100% 100%;box-shadow:0 34px 100px rgba(0,0,0,.52),0 0 44px rgba(57,215,240,.08),inset 0 1px 0 rgba(255,255,255,.1)}.nordic-home-wide .nordic-panel::after{content:"";position:absolute;inset:10px;pointer-events:none;border-radius:20px;background:linear-gradient(90deg,rgba(214,181,109,.18),transparent 20%,transparent 80%,rgba(214,181,109,.18)),var(--nordic-home-runes);background-repeat:no-repeat;background-position:center top;background-size:100% 1px,260px auto;opacity:.45}.nordic-home-wide .nordic-panel>*{position:relative;z-index:1}.nordic-home-wide .nordic-home-hero{background-image:linear-gradient(105deg,rgba(3,7,18,.18),rgba(3,7,18,.78) 62%),var(--nordic-home-hero-frame),var(--nordic-home-bg);background-size:cover,100% 100%,cover;background-position:center;border-color:rgba(214,181,109,.36)}.nordic-home-wide .nordic-home-hero::before{content:"";position:absolute;inset:0;pointer-events:none;background:radial-gradient(circle at 74% 42%,rgba(57,215,240,.28),transparent 22%),radial-gradient(circle at 28% 18%,rgba(214,181,109,.18),transparent 20%);mix-blend-mode:screen}.nordic-home-wide .nordic-home-hero__portrait,.nordic-home-wide .nordic-home-hero__empty{position:relative;z-index:1;padding:7px;background:linear-gradient(145deg,rgba(214,181,109,.26),rgba(57,215,240,.12));box-shadow:0 34px 120px rgba(0,0,0,.64),0 0 70px rgba(57,215,240,.20),inset 0 0 0 1px rgba(255,255,255,.1)}.nordic-home-wide .nordic-home-setup-card,.nordic-home-wide .nordic-home-recipe-card,.nordic-home-wide .battle-rhythm-card,.nordic-home-wide .travel-saga-card,.nordic-home-wide .travel-checklist-item,.nordic-home-wide .nordic-journal-card{background:linear-gradient(145deg,rgba(216,231,239,.09),rgba(3,7,18,.72));border-color:rgba(214,181,109,.20);box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 12px 34px rgba(0,0,0,.22)}.nordic-home-wide .nordic-home-gallery-track{grid-auto-columns:minmax(260px,320px);gap:22px;padding:8px 6px 18px;scrollbar-width:none}.nordic-home-wide .nordic-home-gallery-track::-webkit-scrollbar{display:none}.nordic-home-gallery-tile.nordic-gallery-card{display:grid;grid-template-rows:minmax(230px,260px) auto;min-height:0;aspect-ratio:auto;padding:10px;border-radius:26px;background:linear-gradient(145deg,rgba(3,7,18,.82),rgba(8,17,31,.66));box-shadow:0 26px 70px rgba(0,0,0,.44);overflow:hidden}.nordic-home-gallery-track.nordic-gallery-strip,.nordic-home-wide .nordic-home-gallery-track{grid-auto-columns:minmax(280px,340px);gap:20px;padding:8px 6px 18px;scrollbar-width:none}.nordic-gallery-card .nordic-gallery-media{position:relative;display:block;height:260px;min-height:260px;padding:0!important;border-radius:20px;overflow:hidden;background:#03040a}.nordic-gallery-card .nordic-gallery-media-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;filter:blur(16px) saturate(1.1);opacity:.30;transform:scale(1.1);padding:0!important}.nordic-gallery-card .nordic-gallery-img{position:relative;z-index:1;width:100%;height:100%;object-fit:contain;display:block;padding:0!important}.nordic-gallery-card .nordic-gallery-caption{position:static!important;display:grid;gap:3px;margin-top:8px;padding:8px 4px 2px!important;background:transparent!important;text-shadow:none!important}.nordic-gallery-card .nordic-gallery-caption strong,.nordic-gallery-card .nordic-gallery-caption small{overflow:hidden;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1}.nordic-gallery-card .nordic-gallery-caption small{-webkit-line-clamp:2;color:var(--gl-text-muted);font-size:.78rem}.nordic-home-wide .nordic-home-recipe-card{position:relative;overflow:hidden}.nordic-home-wide .nordic-home-recipe-card::after{content:"";position:absolute;inset:auto 12px 8px 12px;height:1px;background:linear-gradient(90deg,transparent,rgba(214,181,109,.55),transparent)}.nordic-home-wide .nordic-home-recipe-card img{border:1px solid rgba(214,181,109,.22);box-shadow:0 14px 30px rgba(0,0,0,.34)}.nordic-home-wide .nordic-home-battle{background-image:linear-gradient(145deg,rgba(3,7,18,.88),rgba(8,17,31,.72)),var(--nordic-home-runes),var(--nordic-home-frame);background-repeat:no-repeat;background-position:center,center 18px,center;background-size:cover,480px auto,100% 100%}.nordic-home-wide .nordic-home-rhythm-summary{padding:14px 16px;margin-bottom:16px;border:1px solid rgba(214,181,109,.22);border-radius:18px;background:rgba(0,0,0,.22)}.nordic-home-wide .nordic-home-travel,.nordic-home-wide .nordic-home-concierge-panel{background-image:linear-gradient(145deg,rgba(3,7,18,.82),rgba(8,17,31,.72)),var(--nordic-home-travel-bg);background-size:cover;background-position:center}.nordic-home-wide .nordic-home-travel-map{min-height:240px;border-color:rgba(214,181,109,.25);box-shadow:inset 0 0 60px rgba(0,0,0,.52),0 18px 44px rgba(0,0,0,.28)}.nordic-home-wide .nordic-home-concierge{background:linear-gradient(145deg,rgba(214,181,109,.10),rgba(57,215,240,.08)),rgba(0,0,0,.20);border:1px solid rgba(214,181,109,.20)}.nordic-home-wide .nordic-home-journals{background-image:linear-gradient(145deg,rgba(3,7,18,.90),rgba(8,17,31,.76)),var(--nordic-home-frame);background-size:cover,100% 100%}@media(max-width:760px){.nordic-home-gallery-tile.nordic-gallery-card{grid-template-rows:minmax(210px,230px) auto}.nordic-home-wide .nordic-home-gallery-track{grid-auto-columns:minmax(240px,86%);gap:18px}.nordic-gallery-media{min-height:210px}}

.travel-page{--travel-card-bg:linear-gradient(145deg,rgba(216,231,239,.09),rgba(3,7,18,.72))}.travel-title{margin:.2rem 0;color:var(--gl-text-primary);font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(3rem,6vw,6.5rem);line-height:.9}.travel-layout{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(340px,.8fr);gap:22px;align-items:start}.travel-form{display:grid;gap:12px}.travel-form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.travel-form label{display:grid;gap:5px;color:var(--gl-gold-rune);font-size:.78rem;text-transform:uppercase;letter-spacing:.08em;font-weight:800}.travel-form input,.travel-form select,.travel-form textarea,.travel-brief{width:100%;box-sizing:border-box;border:1px solid rgba(216,231,239,.18);border-radius:12px;background:rgba(3,7,18,.56);color:var(--gl-text-primary);padding:10px 12px;font:inherit;text-transform:none;letter-spacing:0}.travel-trip-list,.travel-checklist-list{display:grid;gap:12px}.travel-trip-card,.travel-checklist-card,.travel-home-check-item{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:14px;align-items:center;padding:14px;border:1px solid rgba(214,181,109,.20);border-radius:18px;background:var(--travel-card-bg);color:var(--gl-text-primary);text-decoration:none}.travel-trip-card h3{margin:0;font-family:'Cormorant Garamond',Georgia,serif;font-size:1.6rem}.travel-trip-card p{margin:.25rem 0;color:var(--gl-text-muted)}.travel-trip-card__actions,.travel-tag-row{display:flex;gap:8px;flex-wrap:wrap}.travel-checklist-card,.travel-home-check-item{grid-template-columns:auto minmax(0,1fr) auto}.travel-checklist-card small,.travel-home-check-item small{display:block;color:var(--gl-text-muted);margin-top:2px}.travel-check-button{width:30px;height:30px;border-radius:999px;border:1px solid rgba(57,215,240,.45);background:rgba(57,215,240,.08);color:var(--gl-aurora-cyan);font-weight:900;cursor:pointer}.travel-checklist-card.is-complete,.travel-home-check-item.is-complete{opacity:.72}.travel-checklist-card.is-complete strong,.travel-home-check-item.is-complete strong{text-decoration:line-through}.travel-status-form{display:grid;gap:8px;margin-top:14px}@media(max-width:900px){.travel-layout,.travel-form-grid{grid-template-columns:1fr}}

.travel-status-panel{margin-top:22px}.travel-status-list{display:grid;grid-template-columns:minmax(150px,.35fr) minmax(0,1fr);gap:8px 14px;color:var(--gl-text-muted)}.travel-status-list dt{color:var(--gl-gold-rune);font-weight:800;text-transform:uppercase;font-size:.74rem;letter-spacing:.08em}.travel-status-list dd{margin:0;overflow-wrap:anywhere;color:var(--gl-text-primary)}@media(max-width:700px){.travel-status-list{grid-template-columns:1fr}}

/* Call Dante home gateway card. */
.nordic-home-call-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:16px;align-items:center;margin:18px 6px 4px;padding:18px;border:1px solid rgba(214,181,109,.26);border-radius:24px;background:linear-gradient(135deg,rgba(57,215,240,.10),rgba(214,181,109,.08)),rgba(3,7,18,.58);color:var(--gl-text,#f7efe5);text-decoration:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.08),0 18px 44px rgba(0,0,0,.30)}
.nordic-home-call-card:hover{border-color:rgba(57,215,240,.48);box-shadow:0 0 34px rgba(57,215,240,.12),0 20px 52px rgba(0,0,0,.36)}
.nordic-home-call-card h3{margin:2px 0 4px;font-family:Georgia,'Times New Roman',serif;font-size:1.45rem;line-height:1;color:#fff}
.nordic-home-call-card small{display:block;color:var(--gl-text-muted,#b9c7d6);line-height:1.35}
.nordic-home-call-card>strong{justify-self:end;display:inline-flex;align-items:center;min-height:30px;padding:0 12px;border-radius:999px;border:1px solid rgba(57,215,240,.34);background:rgba(57,215,240,.10);color:var(--gl-aurora-cyan,#39d7f0);font-size:.78rem;text-transform:uppercase;letter-spacing:.08em}
.nordic-home-call-orb{width:48px;height:48px;display:grid;place-items:center;border-radius:18px;border:1px solid rgba(214,181,109,.26);background:radial-gradient(circle,rgba(214,181,109,.22),rgba(57,215,240,.08));color:var(--gl-aurora-cyan,#39d7f0)}
.nordic-home-call-orb img,.nordic-home-call-orb svg{width:28px;height:28px}
@media(max-width:760px){.nordic-home-call-card{grid-template-columns:auto 1fr}.nordic-home-call-card>strong{grid-column:2;justify-self:start}}
`;
